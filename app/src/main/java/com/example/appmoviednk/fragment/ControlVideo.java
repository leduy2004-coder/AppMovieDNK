...
public class ControlVideo extends AbstractYouTubePlayerListener {
    private final YouTubePlayerTracker playerTracker;
    private final YouTubePlayer youTubePlayer;
    private final YouTubePlayerView youTubePlayerView;
    private boolean isFullScreen = false;

    ControlVideo(View controlsUi, YouTubePlayer youTubePlayer, YouTubePlayerView youTubePlayerView) {
        ...
        pausePlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (playerTracker.getState() == PlayerConstants.PlayerState.PLAYING) {
                    pausePlay.setImageResource(R.drawable.ic_baseline_play_circle_filled);
                    youTubePlayer.pause();
                } else {
                    pausePlay.setImageResource(R.drawable.ic_baseline_pause_circle_filled);
                    youTubePlayer.play();
                }
            }
        });
